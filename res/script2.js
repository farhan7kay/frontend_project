...
var grid_gap = "10px";
var grid_padding = "25px";
var grid_cell_padding = "10px";
var grid_cell_paddingBottom = "5px";
var lectures_gap = "25px";
...
function mouse_on_related(price, key) {
    ...
    document.getElementById(key).style.padding = "10px";
    document.getElementById(key).style.borderRadius = "10px";
